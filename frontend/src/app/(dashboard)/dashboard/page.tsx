...
const analysisData = [
  ...
  { name: 'Tue', detections: 3, protected: 13 },
  { name: 'Wed', detections: 2, protected: 98 },
  { name: 'Thu', detections: 7, protected: 39 },
  { name: 'Fri', detections: 1, protected: 48 },
  { name: 'Sat', detections: 2, protected: 38 },
  { name: 'Sun', detections: 4, protected: 43 },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          { label: "Assets in AI Vault", value: stats.total_protected, icon: Shield, color: "text-blue-400", bg: "bg-blue-400/10" },
          { label: "Risk Intel Alerts", value: stats.high_risk_alerts, icon: AlertCircle, color: "text-rose-400", bg: "bg-rose-400/10" },
          { label: "Total Match Analysis", value: stats.total_detections, icon: CheckCircle, color: "text-indigo-400", bg: "bg-indigo-400/10" },
          { label: "Vertex AI Speed", value: "140ms", icon: Zap, color: "text-emerald-400", bg: "bg-emerald-400/10" },
        ].map((stat, i) => (
          <motion.div
            key={i}
