...
import { LayoutDashboard, ShieldAlert, UploadCloud, FileText, Settings, Bell, ShieldCheck, Zap } from "lucide-react";
...
export default function DashboardLayout({
  ...
  const navigation = [
    ...
    { name: "Command Center", href: "/dashboard/hub", icon: Zap },
    { name: "Register Media", href: "/dashboard/upload", icon: UploadCloud },
    { name: "Analyze Content", href: "/dashboard/analyze", icon: ShieldCheck },
