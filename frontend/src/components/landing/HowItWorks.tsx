...
const steps = [
  {
    ...
    description: "Upload official sports media and extract semantic AI features (CLIP embeddings) into the secure Vault.",
    icon: UploadCloud,
  },
  {
    id: "02",
    name: "Detect Suspicious Content",
    description: "Our AI constantly scans for suspect images/videos and compares them with stored official fingerprints.",
    icon: Cpu,
  },
  {
    id: "03",
    name: "Smart Matching",
    description: "Calculate semantic similarity and generate real-time risk assessments and match percentages.",
    icon: AlertTriangle,
  },
  {
    id: "04",
    name: "Evidence Generation",
    description: "Gemini 1.5 generates comprehensive reports with timestamps, similarity scores, and actionable proof.",
    icon: ShieldX,
  },
];
...
export function HowItWorks() {
  return (
    <section id="use-cases" className="py-32 bg-transparent relative overflow-hidden">
