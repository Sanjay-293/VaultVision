...
const features = [
  {
    name: "Hybrid AI Detection",
    description: "Unlike existing tools, detects edited & disguised media using semantic similarity (CLIP) that legacy matching misses.",
    icon: Eye,
  },
  {
    name: "Risk Intelligence System",
    description: "Automated classification of threats into HIGH, MEDIUM, and LOW risk levels, providing actionable insights in real time.",
    icon: Activity,
  },
  {
    name: "Evidence Engine",
    description: "The killer feature: automatically generates professional, downloadable proof with timestamps and similarity analysis.",
    icon: BellRing,
  },
  {
    name: "Clean Dashboard",
    description: "A professional, premium dark-mode dashboard providing real-time alerts, matches, and strategic protection insights.",
    icon: Lock,
  },
];
