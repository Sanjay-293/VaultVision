    ...
    <section className="relative overflow-visible pt-32 pb-32 sm:pt-40 sm:pb-48 font-sans">
      ...
      >
        <div className="mx-auto max-w-4xl text-center">
          ...
          <motion.p
            variants={itemVariants}
            className="mt-8 text-xl leading-relaxed text-slate-300 max-w-4xl mx-auto font-medium"
          >
            VaultVision is a scalable AI-powered system that detects and verifies unauthorized sports media usage in real time using cloud-native architecture.
          </motion.p>
          ...
          >
            <Button 
              size="lg" 
              asChild
              className="min-w-[200px] h-16 text-lg bg-gradient-to-r from-cyan-500 to-blue-600 shadow-[0_10px_30px_rgba(6,182,212,0.4)] cursor-pointer"
            >
              <Link href="/detector">Real-Time Detector</Link>
            </Button>
            <Button 
              size="lg" 
              variant="outline" 
              asChild
              className="min-w-[200px] h-16 text-lg border-white/20 hover:border-white/40 cursor-pointer"
            >
              <Link href="/registry">AI Vault Registry</Link>
            </Button>
          </motion.div>
